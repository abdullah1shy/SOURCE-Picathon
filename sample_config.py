...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/abdullah1shy/SOURCE-Picathon"
    )
    ...
    # specify NO_LOAD with plugin names for not loading in jmthon
    ...
    # Google Drive plugin https://telegra.ph/G-Drive-guide-for-catjmthon-01-01
